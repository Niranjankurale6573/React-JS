...
export default function ThemeBtn() {
    ...
    return (
        <label className="pb-1 relative inline-flex items-center cursor-pointer">
            <input
                type="checkbox"
                value=""
            ...
            <span className="ml-3 text-sm font-medium bg-white p-1 rounded-2xl text-gray-900">Toggle Theme</span>
        </label>
    );
}